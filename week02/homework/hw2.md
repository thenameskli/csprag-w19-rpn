    ...
    <div class="panels col s12">
      <div class="col s12 hide-on-med-and-down" id="user-course-progress">
          ...
          <div class="social-share row">
            ...
            <a href="/courses/git/2" class="action start">Continue Course</a>
      </div>
        ...
        <div class="panel scenario git  col s3">
          ...
          <i class="fa fa-check"></i>
              <a class="action start" href="/courses/git/4" title="Scenario 4 - Undoing Changes">Start Scenario</a>
        </div>
        <div class="panel scenario git  col s3">
          <i class="fa fa-github"></i>
          <div class="content">
...
<footer>
  ...
  <p class="text-right">
    <a href="/docs">Documentation</a> | <a href="/blog">Blog</a> | <a href="/press-kit">Press Kit</a> | <a href="/careers">Careers</a> | <a href="/legal">Legal</a> | <a href="http://twitter.com/teamKatacoda" target="_blank" rel="noreferrer">@teamKatacoda</a> | <a href="/cdn-cgi/l/email-protection#01476e746f65647372414a607560626e65602f626e6c"><span class="__cf_email__" data-cfemail="92d4fde7fcf6f7e0e1d2d9f3e6f3f1fdf6f3bcf1fdff">[email&#160;protected]</span></a>
  </p>
</footer>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function() {
        if (window.trackJs) {
          trackJs.addMetadata("host", 'frugo01');
      ...
      window.on_application_load = function(app) {
          mixpanel.identify("khli@umich.edu");
          mixpanel.people.set({
            "$email": "khli@umich.edu",
            "$created": "",
            "$last_login": new Date(),
            "$name": 'khli@umich.edu',
          });
